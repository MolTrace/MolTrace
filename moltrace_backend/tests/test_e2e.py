...
1-9) and on into the Phase 0 foundation:
    ...
    raw FID
      ...
      -> Regentry handoff: ICH Q2(R2) report stub + GAMP 5 D11 doc
...
* **determinism** -- the structured Regentry handoff is *byte-for-byte*
...
def _run_pipeline(fixture: Path) -> dict[str, Any]:
    """Run the full real-FID pipeline once and assemble the Regentry handoff.
    ...
    # The structured artefact handed to the Regentry.  Every field is a
...
def test_e2e_pipeline_runs_green(tmp_path) -> None:
    ...
    # -- Regentry handoff: ICH Q2(R2) stub is hash-traceable ------- #
