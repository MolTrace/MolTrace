...
class SpectrumRetrieveHit(BaseModel):
    """One retrieved reference spectrum (id + distance, lower = more similar).
    ...
    nuclei_compared: list[str] = Field(default_factory=list)
    nuclei_absent: list[str] = Field(default_factory=list)
