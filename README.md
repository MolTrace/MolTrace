...
- Backend engines: `nmrcheck/reaction_bo.py` (`run_bayesian_optimization`), `nmrcheck/reaction_green.py` (green-chemistry metrics), `nmrcheck/reaction_hte.py` (HTE/DoE plate design), `nmrcheck/reaction_safety.py` (structural safety screening), `nmrcheck/reaction_regulatory_constraints.py` (regulatory-constraint enforcement), and `nmrcheck/reaction_loop.py` (DMTA loop metering + propose-next gate).
