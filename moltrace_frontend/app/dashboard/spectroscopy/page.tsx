...
/**
 * `/dashboard/spectroscopy` was a v0 prototype: a fully static screen with no data
 ...
 * live source behind it to fall back from. It redirects to SpectraCheck, the real
 * surface, so the URL keeps working and lands on data that exists.
 */
export default function Page() {
  redirect("/spectracheck")
}
