...
/* Off-screen (IntersectionObserver-toggled): stop ticking and release the six
   retained GPU textures. Pausing (not \`animation: none\`) keeps each layer's
   rotation phase, so re-entry resumes mid-drift instead of snapping to zero. */
.mt-orbit-paused .mt-orbit {
