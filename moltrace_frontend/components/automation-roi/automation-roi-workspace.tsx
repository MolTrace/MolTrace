  ...
  return (
    <div className="scientific-grid-subtle space-y-6 rounded-xl border bg-card/50 p-4 sm:p-6">
      ...
      <section aria-label="Automation KPIs (demo)">
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-semibold tabular-nums">847</div>
              <p className="mt-1 flex items-center gap-1 text-xs text-muted-foreground">
                <TrendingUp className="h-3 w-3 text-emerald-600 dark:text-emerald-400" aria-hidden />
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-semibold tabular-nums">4,820</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-semibold tabular-nums">156</div>
              <p className="mt-1 flex items-center gap-1 text-xs text-muted-foreground">
                <TrendingUp className="h-3 w-3 text-emerald-600 dark:text-emerald-400" aria-hidden />
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Manual review steps avoided</CardTitle>
              <ListChecks className="h-4 w-4 text-muted-foreground" aria-hidden />
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-semibold tabular-nums">2,341</div>
              <p className="mt-1 text-xs text-muted-foreground">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Avg. upload → report time</CardTitle>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Analyses requiring review</CardTitle>
      ...
      <div className="grid gap-6 lg:grid-cols-5">
          ...
          <CardHeader>
            <div className="flex flex-wrap items-start justify-between gap-2">
              <div>
                ...
                <CardDescription>
                  Rolling weekly mean agreement against held-out verification batches — illustrative series only.
                </CardDescription>
              </div>
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              Scientific credibility depends on traceable evidence — automation reduces volume, not accountability.
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card className="border-primary/20 bg-muted/20">
        <CardHeader>
          <CardTitle className="text-lg">Renewal value summary</CardTitle>
          <CardDescription>
            Condensed storyline for finance and leadership — replace placeholders with audited inputs for contracts.
          </CardDescription>
        </CardHeader>
