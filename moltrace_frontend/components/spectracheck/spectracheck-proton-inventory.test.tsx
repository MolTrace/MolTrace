...
describe("proton inventory panel — CD3OD aromatic-protected aminoglycoside", () => {
  ...
  it("renders a REAL /nmr/processed/analyze payload (sample-c 1H, no SMILES)", async () => {
    ...
    // "(structure-capped)".
    const fixture = (await import("./__fixtures__/sample-c-1h-inventory.json")).default
  ...
  it("renders a REAL structure-aware CD3OD payload end-to-end (sample-c + SMILES)", async () => {
    ...
    const fixture = (await import("./__fixtures__/sample-c-1h-cd3od-structure.json")).default
