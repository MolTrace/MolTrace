...
// ─────────────────────────────────────────────────────────────────────────────
function SpectroscopyExploreInterface({ onClose }: { onClose: () => void }) {
...
function RegulatoryExploreInterface({ onClose }: { onClose: () => void }) {
  return (
    <div
...
function ReactionExploreInterface({ onClose }: { onClose: () => void }) {
  return (
    <div
