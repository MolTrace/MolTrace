 ...
 * Regentry MODULE page (/regulatory-hub):
...
const WORKED_EXAMPLE: LoopStep[] = [
  ...
  },
  {
    ...
    body: "Regentry maps it to ICH Q3C Class 3 (no action below 5000 ppm) and slots it into dossier section 3.2.S.3.2 with the reference shift, observed shift, and delta cited.",
  },
  {
