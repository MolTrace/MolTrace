...
describe("Marketing Header — mobile sidebar refresh", () => {
  ...
  it("opens the sidebar and shows the four marketing sections + items", async () => {
    ...
    // Platform items
    expect(within(sidebar).getByText("Spectroscopy Intelligence")).toBeInTheDocument()
    expect(within(sidebar).getByText("Regulatory Intelligence Hub")).toBeInTheDocument()
