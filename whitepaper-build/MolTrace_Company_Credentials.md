...
- **GDPR (designed to support)** — tenant-private data segregation; a personal-data map with DSAR / right-to-erasure **planning** that assists the controller (Art. 28(3)(e)) rather than adjudicating, with pseudonymisation reported as retained-and-restricted, never as erased. Hosting is **single-region in the United States (`us-central1`) today — there is no EU-region residency or tenant region pinning**
